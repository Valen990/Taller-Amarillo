...
public class Registrarse2 extends javax.swing.JFrame {
    ...
    private void button1_registrarse2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1_registrarse2ActionPerformed
        ...
        try{
            String nombre_m = jTextField2_nombre_c2.getText().trim();
            String apodo = jTextField2_apodo.getText().trim();
            String especie = jTextField2_especie_c.getText().trim();
            String raza = jTextField2_raza_c.getText().trim();
            String color_pelo = jTextField2_color_c.getText().trim();
            String edad_c = jTextField2_edad_c.getText().trim();
            ...
            JOptionPane.showMessageDialog(null, "¡Mascota registrada de manera exitosa!");
